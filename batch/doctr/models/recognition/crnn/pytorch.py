...
default_cfgs: Dict[str, Dict[str, Any]] = {
    'crnn_vgg16_bn': {
        ...
        'url': 'https://libhub-readme.s3.us-west-2.amazonaws.com/model_files/text_extraction/crnn_vgg16_bn-9762b0b0.pt',#'https://github.com/mindee/doctr/releases/download/v0.3.1/crnn_vgg16_bn-9762b0b0.pt',
    },
