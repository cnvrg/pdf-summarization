...
default_cfgs: Dict[str, Dict[str, Any]] = {
    'db_resnet50': {
        ...
        'url': 'https://libhub-readme.s3.us-west-2.amazonaws.com/model_files/text_extraction/db_resnet50-ac60cadc.pt',#'https://github.com/mindee/doctr/releases/download/v0.3.1/db_resnet50-ac60cadc.pt',
    },
    'db_resnet34': {
        'input_shape': (3, 1024, 1024),
        'mean': (.5, .5, .5),
